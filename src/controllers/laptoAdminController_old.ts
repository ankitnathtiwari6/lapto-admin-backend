...
// Middleware to verify Lapto Admin password (for backward compatibility)
...
export const loginLaptoAdmin = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const registerLaptoAdmin = async (req: Request, res: Response): Promise<void> => {
  try {
